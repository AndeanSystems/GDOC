	    ...
	    <div class="row margin-top body-container">
	      	<div class="col-md-12 page-container">
		        ...
		        <div class="row box_control">
		            ...
		            <div class="col-md-2">
          				<button class="btn btn-default" data-toggle="modal" data-target="#modal_form_service"><i class="fa fa-file fa-1x" data-placement="top" data-toggle="tooltip" title="Nuevo"></i></button>
        			</div>
        			<div class="col-md-2"></div>
